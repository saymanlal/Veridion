...
export const LEADERSHIP_DATA: Record<string, LeadershipMember> = {
  elizabeth: {
    ...
    role: 'CEO & Co-Founder',
    icon: 'User',
    bio: 'Atharva leads our overall design vision, product operations, and strategic roadmaps. Under her oversight, Veridion has prioritized light architectures that process enterprise updates instantaneously.',
    instagram: 'https://instagram.com/konmanocha',
    instagram_handle: '@konmanocha',
    twitter: 'https://twitter.com/konmanocha',
    twitter_handle: '@konmanocha',
    linkedin: 'https://linkedin.com/company/konmanocha',
    linkedin_handle: 'konmanocha',
    email: 'atharvamanocha@gmail.com',
  },
  marcus: {
    name: 'Sayman Lal',
    role: 'Lead System Architect',
    icon: 'User',
    bio: 'Sayman commands full system telemetry. He specializes in designing lightweight, distributed REST architectures, optimizing query response rates, and orchestrating native database configurations.',
